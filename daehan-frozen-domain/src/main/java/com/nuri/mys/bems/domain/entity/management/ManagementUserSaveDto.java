...
@Schema(description = "ManagementUserSaveDto")
public class ManagementUserSaveDto {
    ...
    @Schema(description = "생성 유저 이름", example = "admin", maxLength = 255)
    private String objectUserNm;
    @Schema(required = true, description = "신규비밀번호", example = "ifvk76S9OZEg3IHAZgDICvBnepGQgaQw0Nvybc3EOLDOh3UrmLD0qSsqDMJeBT05B/aMF3sB6w+NN6X00UKoisogG+QUne3ysClJhm5GorkfyRmLf0gIa86YOEfOvhPhvcB6QjpUcOwBHbCzGlBIPsoJNJu10DaYyeavCjo2H6c=", maxLength = 255)
    @NotBlank
